                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-offset-2 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="file" name="image" class="form-control input-lg" id="inputFile" value="<?php echo e(old('image')); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                   ...
                                   <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="date" id="date_admitted" class="form-control input-lg" name="date_admitted" value="<?php echo e(old('date_admitted')); ?>" required>
                                        </div>
                                    </div>
                                </div>
                               </div>
