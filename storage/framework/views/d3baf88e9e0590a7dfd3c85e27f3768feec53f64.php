                           ...
                           <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span><input type="text" class="form-control input-lg" name="staff_id" required="" value="<?php echo e(old('staff_id')); ?>">
                                        </div>
                                    </div>
                                </div>
